...
## Javascript Assignments  [![Build Status](https://travis-ci.org/IvanPresmytsky/js-assignments.svg?branch=master)](https://travis-ci.org/IvanPresmytsky/js-assignments)
